...
vrc6_freq_set:
	...
	iny				;yを１増やして
	lda	vrc6_pls_frequency_table,y	;PSG周波数テーブルからHighを読み出す
...
.vrc6_saw_frequency_get:
	...
	sta	sound_freq_low,x	;書き込み
	iny				;yを１増やして
	lda	vrc6_saw_frequency_table,y	;周波数テーブルからHighを読み出す
	sta	sound_freq_high,x	;書き込み
...
vrc6_wave_set:
	...
	cmp	#%10000000
	bne	vrc6_duty_enverope_part	;ヂューティエンベ処理へ
...
vrc6_volume_set:
	...
	and	#%10000000		;bit7確認
	cmp	#%10000000
	bne	vrc6_softenve_part		;ソフトエンベ処理へ
